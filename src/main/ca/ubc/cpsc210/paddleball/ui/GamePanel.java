...
public class GamePanel extends JPanel {
    ...
    private void drawPaddle(Graphics g) {
        ...
        g.fillRect(t.getPaddleX() - pd1 / 2, Paddle.Y_POS - Paddle.DIMENSION2 / 2, pd1, Paddle.DIMENSION2);
        g.setColor(savedCol);
    }
    ...
    private void drawBall(Graphics g) {
        ...
        g.fillOval(b.getBallX() - Ball.SIZE / 2, b.getBallY() - Ball.SIZE / 2, Ball.SIZE, Ball.SIZE);
        g.setColor(savedCol);
    }
